...
const ExtractResumeDataOutputSchema = z.object({
  about: z.string().describe('A summary of the person, extracted from the resume.'),
  experience: z.array(
    z.object({
      ...
      endDate: z.string().describe('The end date of the job.'),
      description: z.string().describe('A description of the job responsibilities and achievements.'),
    })
  ).describe('A list of the persons work experience.'),
  projects: z.array(
    z.object({
  ...
  ).describe('A list of the persons projects.'),
  skills: z.array(z.string()).describe('A list of the persons skills.'),
  education: z.array(
    z.object({
  ...
  ).describe('A list of the persons education.'),
});
...
Make sure to include all available information. If some information is not present fill with 'N/A'.`,
});
